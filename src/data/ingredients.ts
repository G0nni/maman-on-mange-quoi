...
export const INGREDIENTS: Ingredient[] = [
  ...
  { id: 'gigot-d-agneau', label: "Gigot d'agneau", emoji: '🍖', category: 'proteine', protein: 'agneau' },
  { id: 'cotelette-d-agneau', label: "Côtelettes d'agneau", emoji: '🍖', category: 'proteine', protein: 'agneau' },

  // ---------- Protéines : porc et charcuterie ----------
  { id: 'lardon', label: 'Lardons', emoji: '🥓', category: 'proteine', protein: 'porc', groups: ['porc-cuisine'], aliases: ['allumettes', 'lardons fumés'] },
  ...
  { id: 'poitrine-fumee', label: 'Poitrine fumée', emoji: '🥓', category: 'proteine', protein: 'porc', groups: ['porc-cuisine'], aliases: ['bacon'] },
  { id: 'jambon-cru', label: 'Jambon cru', emoji: '🍖', category: 'proteine', protein: 'porc', aliases: ['jambon de Bayonne', 'jambon de Parme'] },
  { id: 'cote-de-porc', label: 'Côtes de porc', emoji: '🥩', category: 'proteine', protein: 'porc', aliases: ['côtelettes de porc'] },
  { id: 'filet-mignon-de-porc', label: 'Filet mignon de porc', emoji: '🥩', category: 'proteine', protein: 'porc', aliases: ['filet mignon'] },
  { id: 'roti-de-porc', label: 'Rôti de porc', emoji: '🥩', category: 'proteine', protein: 'porc' },
  ...
  { id: 'pave-de-saumon', label: 'Pavés de saumon', emoji: '🐟', category: 'proteine', protein: 'poisson', aliases: ['saumon', 'filet de saumon'] },
  { id: 'saumon-fume', label: 'Saumon fumé', emoji: '🐟', category: 'proteine', protein: 'poisson' },
  { id: 'cabillaud', label: 'Cabillaud', emoji: '🐟', category: 'proteine', protein: 'poisson', groups: ['poisson-blanc'], aliases: ['dos de cabillaud'] },
  { id: 'colin', label: 'Colin', emoji: '🐟', category: 'proteine', protein: 'poisson', groups: ['poisson-blanc'], aliases: ['lieu', 'merlu'] },
  ...
  { id: 'yaourt-nature', label: 'Yaourts nature', emoji: '🥛', category: 'laitier', aliases: ['yaourt'] },
  { id: 'fromage-blanc', label: 'Fromage blanc', emoji: '🥛', category: 'laitier' },
  ...
  { id: 'cheddar', label: 'Cheddar', emoji: '🧀', category: 'laitier', protein: 'fromage' },
  { id: 'mozzarella', label: 'Mozzarella', emoji: '🧀', category: 'laitier', protein: 'fromage' },
  ...
  { id: 'semoule', label: 'Semoule', emoji: '🌾', category: 'feculent', aliases: ['couscous', 'graine de couscous'] },
  { id: 'boulgour', label: 'Boulgour', emoji: '🌾', category: 'feculent' },
  { id: 'quinoa', label: 'Quinoa', emoji: '🌾', category: 'feculent' },
  ...
  // ---------- Légumes ----------
  { id: 'tomate', label: 'Tomates', emoji: '🍅', category: 'legume' },
  { id: 'tomate-cerise', label: 'Tomates cerises', emoji: '🍅', category: 'legume' },
  ...
  { id: 'citron', label: 'Citrons', emoji: '🍋', category: 'fruit', aliases: ['citron jaune'] },
  { id: 'citron-vert', label: 'Citrons verts', emoji: '🍋', category: 'fruit' },
